...
public class Main {
	...
	public static void main(String[] args) {
		...
		Cylinder cy = new Cylinder(3, ray, new Color(255, 0, 0), new Material(1, 1, 20));
		Plane pl = new Plane(p3, v, new Color(255, 0, 0), new Material(1, 1, 20));
		Sphere s = new Sphere(8, p4, new Color(255, 0, 0), new Material(1, 1, 20));
		Triangle t = new Triangle(p3, p4, p5, new Color(255, 0, 0), new Material(1, 1, 20));
		...
		Plane p10 = new Plane(p3, p4, p5, new Color(255, 0, 0), new Material(1, 1, 20));
		...
		Cylinder cy1 = new Cylinder(3, ray3, new Color(255, 0, 0), new Material(1, 1, 20));
